...
class CompanyAPITest(TestCase):
    ...
    def test_update_company(self):
        ...
        client = self.get_api_client('company-owner')
        company_info = {
            "name": "codekraf pvt.ltd",
            "description": "this is a good company",
            "website": "http://www.codekraft.in",
            "size": 700,
            "type": "PRIVATE"}

        response = client.put("/api/companies/{}/".format(
            company_id), company_info, format='json')
    ...
    def test_update_company_error_case(self):
        client = self.get_api_client('company-owner')
        company_info = {
            "name": "codekraft",
            "description": "this is a good company",
